...
export default class Lib {
    ...
    static isFunction(value) {
        return typeof value === 'function' && Lib.getTag(value) === '[object Function]'
    }
    ...
    static isString(value) {
        return typeof value === 'string' || (typeof value === 'object' && value != null && !Array.isArray(value) && Lib.getTag(value) === '[object String]')
    }
